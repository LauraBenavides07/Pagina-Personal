...
(function() {
    ...
    if (!dot || !ring) {
        console.log('No se encontraron los elementos del cursor');
        return;
    }
    
    console.log('Cursor encontrado');
    
    // Solo en computadoras, no en celulares
    if (window.innerWidth <= 768) {
        console.log('cursor oculto');
        return;
    }
    ...
    // Animacion del cursor con dos bolitas
